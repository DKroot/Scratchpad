...
import gov.nih.cit.itasng.JhipsterDockerComposeApp;
import gov.nih.cit.itasng.config.Constants;
import gov.nih.cit.itasng.domain.User;
import gov.nih.cit.itasng.repository.AuthorityRepository;
import gov.nih.cit.itasng.repository.UserRepository;
import gov.nih.cit.itasng.security.AuthoritiesConstants;
import gov.nih.cit.itasng.service.UserService;
import gov.nih.cit.itasng.service.dto.PasswordChangeDTO;
import gov.nih.cit.itasng.service.dto.UserDTO;
import gov.nih.cit.itasng.web.rest.vm.KeyAndPasswordVM;
import gov.nih.cit.itasng.web.rest.vm.ManagedUserVM;
...
import static gov.nih.cit.itasng.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
@SpringBootTest(classes = JhipsterDockerComposeApp.class)
