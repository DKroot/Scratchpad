...
import gov.nih.cit.itasng.config.audit.AuditEventConverter;
import gov.nih.cit.itasng.domain.PersistentAuditEvent;
...
import static gov.nih.cit.itasng.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
