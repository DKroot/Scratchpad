...
public class Start implements java.io.Serializable {
     ...
     * @return Start
     */
    public static dk.xml2domain.castor.xi.Start unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (dk.xml2domain.castor.xi.Start) Unmarshaller.unmarshal(dk.xml2domain.castor.xi.Start.class, reader);
    } //-- dk.xml2domain.castor.xi.Start unmarshal(java.io.Reader) 
