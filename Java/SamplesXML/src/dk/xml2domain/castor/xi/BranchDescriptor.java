 ...
 */
public class BranchDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public BranchDescriptor() 
     {
        ...
        desc.setValidator(fieldValidator);
    } //-- dk.xml2domain.castor.xi.BranchDescriptor()
    ...
    {
        return dk.xml2domain.castor.xi.Branch.class;
